(function () {
    ...
    // automation. Every alternative below must stay a real agent name: the /i
    // flag turns any bare generic word into a substring catch-all, which is the
    // exact failure that was removed. robots.txt's catch-all Disallow remains
    // the blanket layer.
